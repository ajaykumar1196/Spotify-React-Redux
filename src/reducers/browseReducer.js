...
export default (state = initalState, action) => {
  switch (action.type) {
    ...
    case browseConstants.FETCH_CATEGORY_PLAYLISTS_PENDING:
      return {
        ...state,
        isFetching: true
      };
    ...
    case browseConstants.FETCH_CATEGORY_PLAYLISTS_SUCCESS:
      return {
        ...state,
    ...
    case browseConstants.FETCH_CATEGORY_PLAYLISTS_FAILURE:
      return {
        ...state,
